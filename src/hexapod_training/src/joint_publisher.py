...
class JointPub(object):
    def __init__(self):
        ...
        self._haa_joint_pub = rospy.Publisher('/hexapod/haa_joint_position_controller/command', Float64, queue_size=1)
        self._hfe_joint_pub = rospy.Publisher('/hexapod/hfe_joint_position_controller/command', Float64, queue_size=1)
        self._kfe_joint_pub = rospy.Publisher('/hexapod/kfe_joint_position_controller/command', Float64, queue_size=1)
